 ...
 */
namespace Neutron\Widget\PageBlockBundle\Form\Type;
...
class PageBlockType extends AbstractType
{
    ...
    {
        $builder->add('general', 'neutron_page_block_general');
        $builder->add('pages', 'neutron_page_block_pages');
